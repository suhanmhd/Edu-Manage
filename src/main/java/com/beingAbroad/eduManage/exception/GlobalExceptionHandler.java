...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    @ExceptionHandler(value =InstituteCodeAlreadyExistsException.class)
    public ApiErrorResponse  handleInstituteCodeAlreadyExistsException(InstituteCodeAlreadyExistsException ex, HttpServletRequest request, HandlerMethod method){
        return new ApiErrorResponse(
                HttpStatus.CONFLICT,
                ex.getMessage(),
                request.getRequestURI(),
